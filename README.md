...
interface와 abstract object를 통한 결합도 낮추기

상위 interface가 적용되 있다면 다른 객체에서 합성요소로 사용가능
...
도메인에 따라서 나누기, 도메인 각각에 MVC가 있을 수 있다.

각 도메인을 뛰어넘어 통신 하는 것은 상위의 state model을 두거나 event를 통해 전역 통신을 한다.
